    ...
    public partial class first : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        CylinderID = c.Int(nullable: false, identity: true),
                        Type = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.CylinderID);
            
            CreateTable(
                "dbo.DriveTypes",
                c => new
                    {
                        DrveTypeID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.DrveTypeID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        GearBoxID = c.Int(nullable: false, identity: true),
                        GearBoxType = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.GearBoxID);
