...
namespace PracticeTest3.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SongID,AlbumID,Path,Title")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongID,AlbumID,Path,Title")] Song song)
        {
            if (id != song.SongID)
            {
                return NotFound();
