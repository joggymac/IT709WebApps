...
namespace Database_Cars.Data.Migrations
{
    ...
    [Migration("20170706031906_somjknjk")]
    partial class somjknjk
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Car_Database.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("Database_Cars.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Car_Database.Models.Car", b =>
                {
                    b.HasOne("Car_Database.Models.CarBrand", "CarBrands")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Database_Cars.Models.ApplicationUser")
                        .WithMany("Claims")
