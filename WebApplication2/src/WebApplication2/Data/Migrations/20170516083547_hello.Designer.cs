...
namespace WebApplication2.Data.Migrations
{
    ...
    [Migration("20170516083547_hello")]
    partial class hello
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WebApplication2.Models.Artist", b =>
                {
                    b.Property<int>("ArtistID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebApplication2.Models.Album", b =>
                {
                    b.HasOne("WebApplication2.Models.Artist", "Artist")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication2.Models.Song", b =>
                {
                    b.HasOne("WebApplication2.Models.Album", "Album")
                        .WithMany()
