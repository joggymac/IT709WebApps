...
namespace Car_Database.Controllers
{
    public class CarModelsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var carModel = await _context.CarModel.SingleOrDefaultAsync(m => m.CarModelID == id);
            if (carModel == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("CarModelID,Name")] CarModel carModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarModelID,Name")] CarModel carModel)
        {
